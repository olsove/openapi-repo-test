...
[![Build Status](https://travis-ci.org/olsove/openapi-repo-test.svg?branch=master)](https://travis-ci.org/olsove/openapi-repo-test)
...
6. If you did everything correct, https://olsove.github.io/openapi-repo-test/ will lead to your new docs
...
- Documentation(ReDoc): https://olsove.github.io/openapi-repo-test/
- SwaggerUI: https://olsove.github.io/openapi-repo-test/swagger-ui/
- Look full spec:
    + JSON https://olsove.github.io/openapi-repo-test/swagger.json
    + YAML https://olsove.github.io/openapi-repo-test/swagger.yaml
- Preview spec version for branch `[branch]`: https://olsove.github.io/openapi-repo-test/preview/[branch]
...
1. Run `npm start`
2. Checkout console output to see where local server is started. You can use all [links](#links) (except `preview`) by replacing https://olsove.github.io/openapi-repo-test/ with url from the message: `Server started <url>`
